...
\begin{titlepage}
    ...
    \begin{minipage}{0.45\textwidth}
        \begin{flushleft}
            \includegraphics[height=2cm, keepaspectratio]{logos/emsi.png}
        \end{flushleft}
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\textwidth}
        \begin{flushright}
            \includegraphics[height=2cm, keepaspectratio]{logos/unica.png}
        \end{flushright}
    \end{minipage}
    ...
    \uline{\textbf{\large Master MIAGE \colorbox{yellow}{I2A}}}
    ...
    \vspace{0.1cm}
    \centering \colorbox{lightgreen}{\makebox[0.45\textwidth][c]{\textit{[ Saad BENDAHOU ]}}} \par
    
    \vspace{0.3cm}
    \raggedright \textbf{Encadrants Professionnels :} \par
    \vspace{0.1cm}
    \centering \colorbox{lightgreen}{\makebox[0.45\textwidth][c]{\textit{[ Mr. Mohamed Agouzzal \textperiodcentered\ CIH Bank ]}}} \par
    \vspace{0.1cm}
    \centering \colorbox{lightgreen}{\makebox[0.45\textwidth][c]{\textit{[ Mr. Marouan Naoui \textperiodcentered\ CIH Bank ]}}} \par

    \vspace{0.3cm}
    \raggedright \textbf{Encadrant Pédagogique :} \par
    \vspace{0.1cm}
    \centering \colorbox{lightgreen}{\makebox[0.45\textwidth][c]{\textit{[ Mr. Marouan Skiti ]}}} \vspace{0.3cm}
    & 
    \vspace{1cm}
    \centering \textbf{Organisme d'accueil :} \par
    \vspace{0.3cm}
    \centering \colorbox{lightgreen}{\makebox[0.3\textwidth][c]{\includegraphics[height=1.5cm, keepaspectratio]{logos/cih.png}}} \par
    \vspace{0.3cm}
    \centering \textit{CIH Bank} \vspace{0.3cm} \\
    \hline
    \end{tabular}
