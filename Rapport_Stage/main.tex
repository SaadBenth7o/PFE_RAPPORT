...
\begin{titlepage}
    ...
    \textbf{Encadrants Professionnels :} \par
    {\centering \textit{Mr. Mohamed Agouzzal \textperiodcentered\ CIH Bank} \\
    \textit{Mr. Marouan Naoui \textperiodcentered\ CIH Bank} \par}
    \vspace{0.3cm}

    \textbf{Encadrant Pédagogique :} \par
    {\centering \textit{Mr. Marouan Skiti} \par}
    \vspace{0.1cm}
    & 
    \begin{center}
