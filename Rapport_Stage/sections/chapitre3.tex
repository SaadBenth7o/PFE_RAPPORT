...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        % Central Fact Table
        \node (fact) [factbox] {
            \centering \textbf{fact\_tiers\_dq\_consolidated} \\ (Vue Dremio - 20 colonnes)
            \nodepart{second}
            ...
            - Date d'exécution \hfill \textit{Date}\\
        ...
        \node (checks) [tablebox, below left=of fact, xshift=-0.5cm, yshift=-0.3cm] {
        ...
        \node (exec) [tablebox, below right=of fact, xshift=0.5cm, yshift=-0.3cm] {
