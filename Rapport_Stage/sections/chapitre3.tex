...
\begin{minipage}[c]{0.22\textwidth}
    ...
    \captionof{figure}{Logo de Oracle NOVA}
\end{minipage}
...
\begin{minipage}[c]{0.22\textwidth}
    ...
    \captionof{figure}{Logo de Apache Sqoop}
\end{minipage}
\hspace{0.03\textwidth}
\begin{minipage}[c]{0.73\textwidth}
...
\begin{minipage}[c]{0.22\textwidth}
    ...
    \captionof{figure}{Logo de HDFS / Apache Hive}
\end{minipage}
\hspace{0.03\textwidth}
\begin{minipage}[c]{0.73\textwidth}
...
\begin{minipage}[c]{0.22\textwidth}
    ...
    \captionof{figure}{Logo de Apache Spark (Spark SQL)}
\end{minipage}
\hspace{0.03\textwidth}
\begin{minipage}[c]{0.73\textwidth}
...
\begin{minipage}[c]{0.22\textwidth}
    ...
    \captionof{figure}{Logo de Apache Airflow 2.2.5}
\end{minipage}
\hspace{0.03\textwidth}
\begin{minipage}[c]{0.73\textwidth}
