...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{
    \begin{tikzpicture}[node distance=2.2cm, >=stealth, every node/.style={font=\normalsize}]
        % Lifelines
        ...
        \node (hdfs) [draw=blue!80!black, fill=blue!10, rounded corners, minimum width=2.5cm, minimum height=1cm, drop shadow, right=of sqoop] {\textbf{Hive / HDFS}};
        \node (soda) [draw=blue!80!black, fill=blue!10, rounded corners, minimum width=2.2cm, minimum height=1cm, drop shadow, right=of hdfs] {\textbf{Soda Core}};
        ...
        % Dotted lines
        \draw [dashed, draw=gray, thick] (airflow) -- +(0,-9.5);
        \draw [dashed, draw=gray, thick] (sqoop) -- +(0,-9.5);
        \draw [dashed, draw=gray, thick] (hdfs) -- +(0,-9.5);
        \draw [dashed, draw=gray, thick] (soda) -- +(0,-9.5);
        \draw [dashed, draw=gray, thick] (dremio) -- +(0,-9.5);
        \draw [dashed, draw=gray, thick] (tableau) -- +(0,-9.5);

        % Execution arrows
        \draw [->, line width=1.2pt] ($(airflow)+(0,-1.5)$) -- node[above, font=\small, text width=2.5cm, align=center] {1. Déclencher\\ingestion} ($(sqoop)+(0,-1.5)$);
        ...
        \draw [->, line width=1.2pt] ($(airflow)+(0,-4.5)$) -- node[above, font=\small, text width=5cm, align=center] {4. Lancer les scans\\de Data Quality} ($(soda)+(0,-4.5)$);
        ...
        \draw [->, line width=1.2pt] ($(dremio)+(0,-8.2)$) -- node[above, font=\small, text width=3.5cm, align=center] {8. Virtualiser en 1\\table de faits} ($(hdfs)+(0,-8.2)$);
        \draw [<-, line width=1.2pt] ($(dremio)+(0,-9.1)$) -- node[above, font=\small, text width=3cm, align=center] {9. Requêter le\\Dashboard} ($(tableau)+(0,-9.1)$);
    \end{tikzpicture}
    }
