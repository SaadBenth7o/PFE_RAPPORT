...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=stealth, every node/.style={font=\small}, box/.style={draw=blue!80!black, rectangle, fill=blue!5, rounded corners, minimum width=2.8cm, minimum height=1cm, align=center, drop shadow}]
        ...
        \node (soda) [box, right=of dag_dq, xshift=1.5cm] {Moteur DQ \\ \scriptsize(Script SH + Python)};
        \node (res) [box, right=of soda, xshift=0.5cm] {Résultats DQ \\ \scriptsize(Tables Hive)};
        ...
        \draw [->, line width=1pt, dashed, orange!80!black] (dag_dq) -- node[above, font=\scriptsize] {Appelle script .sh} (soda);
