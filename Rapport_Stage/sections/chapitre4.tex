...
Cet onglet affiche :
\begin{itemize}
    \item Le score DQ global du jour pour le domaine Tiers (indicateurs chiffrés 0–100)
...
\subsection{Onglet 2 — Détails Métier}

La figure \ref{fig:dashboard_kyc} présente l'onglet « Détails Métier ».

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/dashboard_kyc.png}
    \caption{Dashboard Tableau — Détails Métier : score par colonne et dimension DQ}
